  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">View and update your account information.</p>
      </div>
        ...
        <div className="card p-6 space-y-4">
          ...
          <div className="space-y-3">
            <div className="rounded-xl border border-slate-200/60 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800">
              <p className="text-xs font-medium uppercase tracking-wider text-slate-400 dark:text-slate-500">ID Number</p>
