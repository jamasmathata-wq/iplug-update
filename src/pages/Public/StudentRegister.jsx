    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mx-auto max-w-lg">
      <div className="card p-8">
        <div className="mb-6 text-center">
          ...
          <h1 className="mt-3 text-2xl font-bold text-slate-900 dark:text-white">Create your verified account</h1>
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Registration is only permitted if your Student Number exists in the college verification database.</p>
        </div>
        ...
        <form className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            <input type="text" placeholder="S1234567" className="input-field" />
          </div>
          <div>
          ...
          <div className="sm:col-span-2 space-y-4">
            ...
            <p className="text-center text-sm text-slate-500 dark:text-slate-400">Already registered? <Link to="/student-login" className="font-semibold text-primary">Sign in</Link></p>
          </div>
        </form>
      </div>
    </motion.div>
