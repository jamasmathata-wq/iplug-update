    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mx-auto max-w-md">
      <div className="card p-8">
        <div className="mb-6 text-center">
          <span className="section-label">Lecturer Login</span>
          <h1 className="mt-3 text-2xl font-bold text-slate-900 dark:text-white">Sign in to your portal</h1>
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Review assignments, upload resources, and manage announcements.</p>
        </div>
